import { getAllCafes, getCafesByCity, getCafeById, getAllBoardGamesByCafeId } from "../services/cafe-service.js";
...
export const getBoardGamesByCafeIdController = async (req, res) => {
  try {
    const { id } = req.params;
    const boardGames = await getAllBoardGamesByCafeId(id);
